...
public class AddressPickerDialog extends Dialog {
	...
	public AddressPickerDialog(Context context,DialogListener listener,String province,String city,String county,Country country) {
		...
		findViewById(R.id.btnOK).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				dialogListener.setAddress(
						provinceMap.get(provinceArray[provinceWheelView.getCurrentItem()]), 
	...
	public void initWheelView() {
		...
		//设置选中的颜
		provinceWheelView.setCurrentColor(getContext().getResources().getColor(R.color.addresspickselect));
		cityWheelView.setCurrentColor(getContext().getResources().getColor(R.color.addresspickselect));
		areaWheelView.setCurrentColor(getContext().getResources().getColor(R.color.addresspickselect));
		
		initProviceMap();
		provinceAdapter = new ProviceCityAreaAdapter(applicationContext, provinceArray, 0);
		...
		if (provinceCode ==null || provinceCode.isEmpty()){
			provinceCode =provinceMap.get(provinceArray[provinceWheelView.getCurrentItem()]);
		}
		initCityMap(provinceCode);
	
		cityAdapter = new ProviceCityAreaAdapter(applicationContext, cityArray, 0);
		...
		areaAdapter = new ProviceCityAreaAdapter(applicationContext, areaArray, 0);
