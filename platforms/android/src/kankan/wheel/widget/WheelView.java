...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFa1a9ca,
			0x00c9cad0, 0x00FFFFFF };
    ...
    private int currentColor=TextColor;
	/**
	 * Constructor
	 */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		this.changeSizeAndColorOnScroll();
	}
	 ...
	 * 随着滚动而改变字体的大小与颜色
	 */
	public void changeSizeAndColorOnScroll()
	{
		//如果不是textAdapter 则不更改
		if(this.viewAdapter instanceof AbstractWheelTextAdapter){
			int DefaultSize = AbstractWheelTextAdapter.DEFAULT_TEXT_SIZE;
			int ChangeSize = 4;
			for(int i = 0;i<this.itemsLayout.getChildCount();i++)
			{
				View view = itemsLayout.getChildAt(i);
					...
					int size = DefaultSize-ChangeSize*(Math.abs(index-currentItem));
	...
	//设置currentItem 选中时的颜色, 如查不设置，则不显示
