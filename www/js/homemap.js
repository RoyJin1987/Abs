  ...
  addVehicleMaker:function(BMapPoint,isAnimated,opts,vehicle)  {
    ...
    if (app.map) {
      ...
      var content = "<div style='padding:2px 5px;font-size:.8em'>"
                     ...
                     +"<a href='requestDelivery.html?model="+app.currentModel+"&id="+vehicle.item.motorcadeKey+"&identity="+vehicle.identity+"'><img style='width:80px;height:80px' src='img/map/jiujiaota_gr.png'></img></a></div>"
